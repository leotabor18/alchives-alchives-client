    ...
    return (
      <div className={classes.bookContentStudents} ref={ref}>
        <Container className={classes.bookContainer}>
          {
            props.chunk.map(student => (
              <Box style={{display: 'flex', alignItems: 'center', marginBottom: '20px'}}>
                <img className={classes.gradPic} src={student.image ? student.image : gradPic} alt='Alumni Background Image' />
                <Box className={classes.textBox}>
                  <Box style={{display: 'flex', alignItems: 'center'}}>
                    
                    <AutoAwesome style={{fontSize: '14px', color: '#4D6A34', marginRight: '4px'}} />
                    <Typography style={{fontSize: '12px'}}>{'Cum Laude'}</Typography>
                  </Box>
                  <Typography style={{fontSize: '20px', fontWeight: 'bold', color: '#4D6A34'}}>{`${student.lastName}, ${student.firstName}`}</Typography>
                  <Typography style={{fontSize: '12px', fontStyle: 'italic'}}>"{student.quotes}"</Typography>
                </Box>
              </Box>
            ))
          }
          ...
          <Container className={classes.container}>
            {
              ...
              maxWidth={1000}
                ...
                <PageCover sx={{ boxShadow: 2 }}>
                  <PageCoverContent src={alumniBackgroundImage} alt='Alumni Background Image' />
              ...
              {
                byThreeData.map((chunk, index) => (
                  <PageContent key={index} chunk={chunk} />
                  ))
              }
                {/* <div sx={{ boxShadow: 2 }} className={`${classes.bookContent} ${classes.cover}`}></div> */}
                <PageCover></PageCover>
